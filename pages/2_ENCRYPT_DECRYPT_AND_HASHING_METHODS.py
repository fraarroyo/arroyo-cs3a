...
def homepage():
    ...
    with col1:
        st.image('435792060_908559531280445_5041796525148081874_n.jpg', width=col_width, caption='Francis Arroyo')
    with col2:
        st.image('80ba58d9-8951-4f51-a6aa-6b0dd67acad5.jpg', width=col_width, caption='Ma Veronica Beltrano')
    with col3:
